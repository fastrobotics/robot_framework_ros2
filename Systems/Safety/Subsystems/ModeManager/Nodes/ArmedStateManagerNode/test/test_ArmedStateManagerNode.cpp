/**
 * @file test_ArmedStateManagerNode.cpp
...
std::string nodeNamespace = "safety/modemanager/armedstatemanager";
std::string nodeUnderTest = "armed_state_manager_node";
class ArmedStateManagerNodeTestFixture : public ::testing::Test {
   protected:
    void SetUp() override {
        test_node = std::make_shared<rclcpp::Node>("armed_state_manager_node_tester_agent", nodeNamespace);
...
TEST_F(ArmedStateManagerNodeTestFixture, VerifyHeartbeatReception) {
