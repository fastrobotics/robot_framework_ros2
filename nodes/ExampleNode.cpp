...
namespace fast::rf_ros2 {
    ...
    bool ExampleNode::initData() { return true; }
    void ExampleNode::run100Hz() { fast::rf::Logger::logDebug("100 Hz"); }
    void ExampleNode::run10Hz() { fast::rf::Logger::logDebug("10 Hz"); }
    void ExampleNode::run1Hz() { fast::rf::Logger::logDebug("1 Hz"); }
    void ExampleNode::run01Hz() { fast::rf::Logger::logDebug("0.1 Hz"); }
    void ExampleNode::run001Hz() { fast::rf::Logger::logDebug("0.01 Hz"); }
    void ExampleNode::runLoop1() { fast::rf::Logger::logDebug("Loop1"); }
